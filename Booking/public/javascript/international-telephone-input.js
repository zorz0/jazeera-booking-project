   ...
   ********************/
        ...
        _appendListItems: function(countries, className) {
            ...
            for (var i = 0; i < countries.length; i++) {
                ...
                // add the flag
                tmp += "<div class='flag-icon-" + c.iso2 + "'></div>";
        ...
        _selectFlag: function(countryCode) {
            ...
            this.selectedFlagInner.attr("class", "flag-icon-" + countryCode);
            ...
            if (countryCode) {
                this.selectedFlagInner.parents('.intl-tel-input').find('input.form-control:text').val('+'+ this.selectedCountryData.dialCode);
                this.countryListItems.children(".flag-icon-" + countryCode).first().parent().addClass("active");
            }
        },
