    ...
    #flight_search_promo_code_oneway .input-invert{
        position:fixed;
            ...
            <section class="search-flights-wrapper" id="outside-click">
                <div class="container">
                    <div class="tab-panel">
                        ...
                        <a href="#flights" class="btn btn-switch active" id="flights-in-url"
                           data-collapse>Flights</a>
                                    ...
                                    <div class="sticky-fields" id="to-input-reset">
                                            ...
                                            <div class="form-row row location-ltr widjet-adding-class">
                                                <div class="col-md-6 locations booking-widgit">
                                                    ...
                                                    <div class="form-field float-label-wrapper">
                                                        ...
                                                        <input id="from_flight_search" name="from_flight_search"
                                                               type="text"
                                                               class="form-control input-invert location-select from"
                                                               value="" autocomplete="off" placeholder="&#x645;&#x646;"
                                                               tabindex="1">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 locations travel-advisory-to disabled booking-widgit"
                                                    ...
                                                    <div class="form-field float-label-wrapper">
                                                        ...
                                                        <input id="to_flight_search" name="to_flight_search"
                                                               type="text"
                                                               class="form-control input-invert location-select to"
                                                               value="" autocomplete="off"
                                                               placeholder="&#x625;&#x644;&#x649;" tabindex="2">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-row row hidden return_date_picker"
                                                 id="ClickHideReturn">
                                                    ...
                                                    <div class="group-field-wrap">
                                                        ...
                                                        <div class="range-picker-wrap first-grid">
                                                            ...
                                                            <div class="range-picker"
                                                                 id="departure_flight_date_range"></div>
                                                        </div>
                                                    </div>
                                                    <div class="group-field-wrap">
                                                        <div
                                                            class="form-field float-label-wrapper booking_date_return">
                                                                <span class="icon">
                                                                    <i class="icon-calender-range"></i>
                                                                </span>
                                                            <label for="name">&#x630;&#x647;&#x627;&#x628;
                                                                &#x648;&#x639;&#x648;&#x62F;&#x629;</label>
                                                            <input id="return_flight_search"
                                                                   name="return_flight_search" type="text"
                                                ...
                                                <div class="col-md-4 pr-0">
                                                    <div class="form-field float-label-wrapper passengers_field">
                                                        ...
                                                        <input id="passengers_flight_search"
                                                               name="passengers_flight_search" type="text"
                                                            ...
                                                            <div class="dropdown-option">
                                                                ...
                                                                <div class="spinner-wrap"
                                                                    ...
                                                                    <div data-trigger="spinner"
                                                                         class="spinner-input">
                                                                        <button type="button"
                                                                                id="roundChild_btn_down"
                                                                                data-spin="down">-</button>
                                                                        <input type="text" value="0" data-min="0"
                                                                               readonly="true" data-max="9"
                                                                               id="roundChild" readonly="true">
                                                            ...
                                                            <div class="dropdown-option">
                                                                ...
                                                                <div class="spinner-wrap"
                                                                    ...
                                                                    <div data-trigger="spinner"
                                                                         class="spinner-input">
                                                                        <button type="button"
                                                                                id="roundInfant_btn_down"
                                                                                data-spin="down">-</button>
                                                                        <input type="text" value="0" data-min="0"
                                                                               readonly="true" data-max="4"
                                                                               id="roundInfant" readonly="true">
                                                                        <button type="button"
                                                                                id="roundInfant_btn_up" data-spin="up"
                                                                ...
                                                                <div class="dropdown-option">
                                                                    ...
                                                                    <div class="spinner-wrap"
                                                                        ...
                                                                        <div data-trigger="spinner"
                                                                             class="spinner-input">
                                                                            <button type="button"
                                                                                    id="roundExtra_btn_down"
                                                                                    data-spin="down">-</button>
                                                                            <input type="text" value="0"
                                                                                   data-min="0" readonly="true"
                                                                                   data-max="9" id="roundExtra"
                                                                                   readonly="true">
                                                                            <button type="button"
                                                                                    id="roundExtra_btn_up"
                                                                                    data-spin="up"
                                                                                    class="disabled">+</button>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="form-btn-wrap hidden travel-advisory-message div_jusify promo_code_values"
                                                            ...
                                                            <div class="group-field-wrap">
                                                                <div
                                                                    ...
                                                                    <input id="flight_search_promo_code" type="text"
                                                                           class="form-control input-invert"
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="form-field float-label-wrapper special_fare_container_field">
                                    ...
                                    <div class="oneway-sticky-fields" id="OnewayToInputReset">
                                                ...
                                                <div class="col-md-6 locations disabled  travel-advisory-to"
                                                    ...
                                                    <div class="form-field float-label-wrapper">
                                                        ...
                                                        <input id="to_flight_search_oneway"
                                                               name="to_flight_search_oneway" type="text"
                                                               class="form-control input-invert location-select to"
                                                               value="" autocomplete="off"
                                                               placeholder="&#x625;&#x644;&#x649;" tabindex="2">
                                                    </div>
                                                ...
                                                <div class="col-md-4 pr-0">
                                                    <div class="form-field float-label-wrapper">
                                                        ...
                                                        <input id="passengers_flight_search_oneway"
                                                               ...
                                                               value="1 Adult" data-toggle="dropdown-menu"
                                                               autocomplete="off"
                                                               placeholder=">&#x631;&#x643;&#x627;&#x628;" tabindex="4"
                                                               readonly>
                                                        <div class="dropdown-menu"
                                                             class="passengers_flight_search_list">
                                                            <div class="dropdown-option">
                                                                <h5><strong>&#x628;&#x627;&#x644;&#x63A;</strong> (
                                                                    &#x627;&#x644;&#x623;&#x639;&#x645;&#x627;&#x631;
                                                                    12+ )</h5>
                                                                <div class="spinner-wrap"
                                                                    ...
                                                                    <div data-trigger="spinner"
                                                                         class="spinner-input">
                                                                        <button id="oneWayAdult_btn_down"
                                                                                type="button"
                                                                                data-spin="down">-</button>
                                                                        <input type="text" value="1" data-min="1"
                                                                               readonly="true" data-max="9"
                                                                               id="oneWayAdult">
                                                                        <button id="oneWayAdult_btn_up"
                                                                                type="button" data-spin="up">+</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="dropdown-option">
                                                                ...
                                                                <div class="spinner-wrap"
                                                                    ...
                                                                    <div data-trigger="spinner"
                                                                         class="spinner-input">
                                                                        <button id="oneWayChild_btn_down"
                                                                                type="button"
                                                                                data-spin="down">-</button>
                                                                        <input type="text" value="0" data-min="0"
                                                                               readonly="true" data-max="9"
                                                                               id="oneWayChild">
                                                                        <button id="oneWayChild_btn_up"
                                                                                type="button" data-spin="up">+</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="dropdown-option">
                                                                ...
                                                                <div class="spinner-wrap"
                                                                    ...
                                                                    <div data-trigger="spinner"
                                                                         class="spinner-input">
                                                                        <button id="oneWayInfant_btn_down"
                                                                                type="button"
                                                                                data-spin="down">-</button>
                                                                        <input type="text" value="0" data-min="0"
                                                                               readonly="true" data-max="4"
                                                                               id="oneWayInfant">
                                                                        <button id="oneWayInfant_btn_up"
                                                                                type="button" data-spin="up"
                                                                                class="disabled">+</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="dropdown-option">
                                                                        ...
                                                                        <div class="tooltip">
                                                                            ...
                                                                            <span
                                                                                class="tooltiptext">&#x627;&#x62D;&#x62C;&#x632;
                                                                                    ...
                                                                                    &#x62E;&#x644;&#x627;&#x644;
                                                                                    &#x627;&#x644;&#x631;&#x62D;&#x644;&#x629;<br><a
                                                                                    href="{{ route('duo-seat') }}"                                                                                    target="_blank"
                                                                                    style="color:#03618a;">&#x644;&#x645;&#x632;&#x64A;&#x62F;
                                                                                        &#x645;&#x646;
                                                                                        &#x627;&#x644;&#x645;&#x639;&#x644;&#x648;&#x645;&#x627;&#x62A;
                                                                                        &#x627;&#x636;&#x63A;&#x637;
                                                                    ...
                                                                    <div class="spinner-wrap"
                                                                        ...
                                                                        <div data-trigger="spinner"
                                                                             class="spinner-input">
                                                                            <button type="button"
                                                                                    id="oneWayExtra_btn_down"
                                                                                    data-spin="down">-</button>
                                                                            <input type="text" value="0"
                                                                                   data-min="0" readonly="true"
                                                                                   data-max="9" id="oneWayExtra"
                                                                                   readonly="true">
                                                                            <button type="button"
                                                                                    id="oneWayExtra_btn_up"
                                                                                    data-spin="up"
                                                                                    class="disabled">+</button>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="form-btn-wrap hidden travel-advisory-message div_jusify oneway-sticky-promo sticky oneway_promo_code"
                                                            ...
                                                            <div class="group-field-wrap">
                                                                <div
                                                                    ...
                                                                    <label for="name"
                                                                        ...
                                                                        &#x627;&#x644;&#x631;&#x645;&#x632;
                                                                        &#x627;&#x644;&#x62A;&#x631;&#x648;&#x64A;&#x62C;&#x64A;</label>
                                                                    <input id="flight_search_promo_code_oneway"
                                                                           type="text"
                                                                           class="form-control input-invert"
                                                                           autocomplete="off" value=""
                                                                           placeholder="&#x623;&#x62F;&#x62E;&#x644; &#x627;&#x644;&#x631;&#x645;&#x632; &#x627;&#x644;&#x62A;&#x631;&#x648;&#x64A;&#x62C;&#x64A;"
                                            ...
                                            <div class="PassengerDiscount form-row row passenger_type">
                                                <div
                                                    class="form-field float-label-wrapper oneway_special_fare_container">
                            ...
                            <div class="sub-panel-data" id="multi-city" data-panel>
                                <form action="" id="searchMultiCityFlight" name="searchMultiCityFlight">
                                    ...
                                    <div class="sticky-fields new-sticky-class-for-down" id="multicity-sticky">
                                            ...
                                            <div class="col-md-8 group-field locations_multicity d-flex">
                                                <div class="group-field-wrap locations col-md-6">
                                                    ...
                                                    <div class="form-field float-label-wrapper">
                                                        ...
                                                        <label
                                                            for="from_flight_search_muticity1">&#x645;&#x646;</label>
                                        ...
                                        <!--1-->
                                        <!--2-->
                                        <div class="form-row row form-wrap new_multi_2_sticky"
                                             id="addmulticity2sticky">
                                            <div class="col-md-8 group-field locations_multicity d-flex">
                                                <div class="group-field-wrap col-md-6 locations multicity-form-row">
                                                    ...
                                                    <div class="form-field float-label-wrapper">
                                                        ...
                                                        <label
                                                            for="from_flight_search_muticity2">&#x645;&#x646;</label>
                                                            ...
                                                            <div class="dropdown-option">
                                                                ...
                                                                <div class="spinner-wrap"
                                                                    ...
                                                                    <div data-trigger="spinner"
                                                                         class="spinner-input">
                                                                        <button type="button"
                                                                                id="multiWayAdult_btn_down"
                                                                                data-spin="down">-</button>
                                                                        <input type="text" value="1" data-min="1"
                                                                               readonly="true" data-max="9"
                                                                               id="multiWayAdult">
                                                                        <button type="button"
                                                                                id="multiWayAdult_btn_up"
                                                                                data-spin="up">+</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="dropdown-option">
                                                                ...
                                                                <div class="spinner-wrap"
                                                                    ...
                                                                    <div data-trigger="spinner"
                                                                         class="spinner-input">
                                                                        <button type="button"
                                                                                id="multiWayChildren_btn_down"
                                                                                data-spin="down">-</button>
                                                                        <input type="text" value="0" data-min="0"
                                                                               readonly="true" data-max="9"
                                                                               id="multiWayChild">
                                                                        <button type="button"
                                                                                id="multiWayChildren_btn_up"
                                                                                data-spin="up">+</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="dropdown-option">
                                                                ...
                                                                <div class="spinner-wrap"
                                                                    ...
                                                                    <div data-trigger="spinner"
                                                                         class="spinner-input">
                                                                        <button type="button"
                                                                                id="multiWayInfant_btn_down"
                                                                                data-spin="down">-</button>
                                                                        <input type="text" value="0" data-min="0"
                                                                               readonly="true" data-max="4"
                                                                               id="multiWayInfant">
                                                                        <button type="button"
                                                                                id="multiWayInfant_btn_up"
                                                                                data-spin="up"
                                                                                class="disabled">+</button>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="dropdown-option">
                                                                    ...
                                                                    <div class="spinner-wrap"
                                                                        ...
                                                                        <div data-trigger="spinner"
                                                                            ...
                                                                            <input type="text" value="0"
                                                                                   data-min="0" readonly="true"
                                                                                   data-max="9" id="multiWayExtra"
                                                                                   readonly="true">
                                                                            <button type="button"
                                                                                    id="multiWayExtra_btn_up"
                                                                                    data-spin="up"
                                                                                    class="disabled">+</button>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-field float-label-wrapper">
                                                <label for="email_manage_booking"
                                                    ...
                                                    / &#x627;&#x633;&#x645;
                                                    &#x627;&#x644;&#x639;&#x627;&#x626;&#x644;&#x629;</label>
                                                <input id="email_manage_booking" name="email_manage_booking"
                                                       type="text" class="form-control input-invert" autocomplete="off"
            ...
            <script type="text/javascript">
                ...
                var userType = document.cookie.includes("agent_dashboardCookie") ? 'agent' : document.cookie.includes("loggedInUser") ? 'member' : 'guest';
            ...
            <script type="text/javascript">
                ...
                function loadAnalyticsDataForFlightsReturnType() {
                    ...
                    var dataLayerFlightSearchReturn = {
                        'event': 'flight_search',
                        'journeyRoute': /\(([^)]*)\)/.exec(fromFlightReturn)[1] + '-' + /\(([^)]*)\)/.exec(toFlightReturn)[1],//Flights/holidays
                ...
                function loadAnalyticsDataForFlightsOneWayType() {
                    ...
                    var dataLayerFlightSearchOneway = {
                        ...
                        'event': 'flight_search',
                        'journeyRoute': /\(([^)]*)\)/.exec(fromFlightOneway)[1] + ' - ' + /\(([^)]*)\)/.exec(toFlightOneway)[1],//Flights/holidays
                ...
                function loadAnalyticsDataForFlightsMultiCityType() {
                    ...
                    var dataLayerFlightSearchMultiway = {
                        ...
                        'event': 'flight_search',
                        'journeyRoute': /\(([^)]*)\)/.exec(fromFlightMultiway1)[1] + '-' + /\(([^)]*)\)/.exec(toFlightMultiway1)[1] + ',' + /\(([^)]*)\)/.exec(fromFlightMultiway2)[1] + '-' + /\(([^)]*)\)/.exec(toFlightMultiway2)[1],//Flights/holidays
                        'journeyTripType': 'MultiCity',//Return/Oneway
                        'journeySource': /\(([^)]*)\)/.exec(fromFlightMultiway1)[1] + ',' + /\(([^)]*)\)/.exec(fromFlightMultiway2)[1],
                        'journeyDestination': /\(([^)]*)\)/.exec(toFlightMultiway1)[1] + ',' + /\(([^)]*)\)/.exec(toFlightMultiway2)[1],
                        'journeyDepartDate': moment(departDate).format("YYYY-MM-DD") + ',' + moment(departDate2).format("YYYY-MM-DD"),
                        'journeyBookingDate': moment(bookingDate).format("YYYY-MM-DD"), //Booking Date
                ...
                $('.slideshow').click(function () {
                    ...
                    dataLayer.push({
                        ...
                        'userType': userType, 'language': language,
                        'country': localStorage.pageCountry.toUpperCase(),
                        'channel': 'Web',
                        'pos': 'J9WEB'
                    });
                ...
                $('.flighttabs').click(function (e) {
                    ...
                    if (target.is('.flighttabs a')) {
                        homeTabsClick = {
                            ...
                            'userType': userType, 'language': language,
                            'country': (localStorage.pageCountry != undefined && localStorage.pageCountry != '') ? localStorage.pageCountry.toUpperCase() : "",
                            'channel': 'Web',
                            'pos': 'J9WEB'
                        };
                    }
                ...
                function userdetails() {
                    ...
                    document.getElementById("detailsmem").innerHTML = paln == 1 ? '&#x627;&#x644;&#x628;&#x627;&#x642;&#x629; &#x627;&#x644;&#x641;&#x631;&#x62F;&#x64A;&#x629;' : paln == 2 ? '&#x627;&#x644;&#x628;&#x627;&#x642;&#x629; &#x627;&#x644;&#x62B;&#x646;&#x627;&#x626;&#x64A;&#x629;' : paln == 3 ? '&#x627;&#x644;&#x628;&#x627;&#x642;&#x629; &#x627;&#x644;&#x639;&#x627;&#x626;&#x644;&#x64A;&#x629; &#x623;' : '&#x627;&#x644;&#x628;&#x627;&#x642;&#x629; &#x627;&#x644;&#x639;&#x627;&#x626;&#x644;&#x64A;&#x629; &#x628;';
                    ...
                    <div class="features-scroller cards-grid-3">
                        <div class="carousel-wrap">
                            <div class="carousel" data-slick='{"slidesToShow": 3, "slidesToScroll": 1}'>
                                <div class="slick-item promotionalItem" data-value="J Caf&#xE9;"
                                     style="height:578px">
                                    <div class="card feature-card">
                                        <a href="{{ route('jazeeracafe') }}">
                                            <div class="card-img-wrap">
                                                <img class="card-img-top lazyload" src="/images/jazeera-cafe.jpg"
                                                     alt="">
                                            </div>
                                        ...
                                        <a href="https://jazeera.tripadmit.com/">
                                            <div class="card-img-wrap">
                                                <img class="card-img-top lazyload"
                                                     src="/images/tripadmit-home-img.jpg" alt="">
                                            </div>
                                ...
                                <div class="slick-item promotionalItem" data-value="VIV" style="height:578px">
                                    <div class="card feature-card">
                                        <a href="https://viv.com.kw/?lang=ar">
                                            <div class="card-img-wrap">
                                                <img class="card-img-top lazyload" src="/images/viv-arabic.jpg"
                                                     alt="">
                                            </div>
                                            <div class="card-body first_card_body" style="height:200px">
            ...
            <script>
                ...
                $('.promotionalItem').click(function () {
                    ...
                    dataLayer.push({
                        ...
                        'productName': a,
                        'userType': document.cookie.includes("agent_dashboardCookie") ? 'agent' : document.cookie.includes("loggedInUser") ? 'member' : 'guest', 'language': window.location.href.indexOf('/ar-') > 0 ? 'ar' : 'en',
                        'country': localStorage.pageCountry.toUpperCase(),
                        'channel': 'Web',
                        'pos': 'J9WEB'
                    })
